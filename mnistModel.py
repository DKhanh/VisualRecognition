...
LOGDIR = './logs/mnist_cnn/tensorboard/'
MODEL_NAME = "./saved_model/mnist_cnn/cnn_model.ckpt"
...
NUM_FILTERS3 = 32         # There are 16 of these filters.
...
NUM_FILTERS5 = 64         # There are 16 of these filters.
...
FC1_SIZE = 1024             # Number of neurons in fully-connected layer.
...
def createNewConV(input,              # The previous layer
  ...
  layer = tf.add(conv2d(input, weights), biases)
  ...
  with tf.device("/cpu:0"):
    ...
    with tf.name_scope('pattern3'):
      ...
      with tf.name_scope('ConvLayer6'):
        conv_layer6, W_conv6, b_conv6 = createNewConV(conv_layer5, FILTER_SIZE6, NUM_FILTERS5, NUM_FILTERS6, use_pooling=True, batch_normalize=False)
